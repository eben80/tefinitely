...
<body>
    ...
    <div class="container">
            ...
            <div id="user-management-tab" class="tab-content active">
                <div class="header-with-button">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        <button id="update-test-questions-btn" class="action-btn" style="background-color: #17a2b8;">Update Test Questions</button>
        ...
        <div id="auth-error" style="display: none; text-align: center; margin-top: 5rem;">
            <h2>Access Denied</h2>
            <p>You must be an administrator to view this page. <a href="login.php">Login as Admin</a></p>
        </div>
    </div>
