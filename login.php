...
<script>
  ...
  gtag('config', 'G-NDEYBJ5FQB');
    ...
    <style>
        ...
        .auth-btn { width: 100%; padding: 0.7rem; font-size: 1rem; background-color: #007bff; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: bold; }
        ...
        .auth-tab { flex: 1; text-align: center; padding: 1rem; cursor: pointer; font-weight: bold; color: #666; transition: all 0.3s; }
        ...
        .google-btn-container { margin-bottom: 1.5rem; border-bottom: 1px solid #eee; padding-bottom: 1.5rem; display: flex; justify-content: center; }

        .requirements { text-align: left; font-size: 0.85rem; color: #666; margin-bottom: 1rem; margin-top: 0.5rem; }
        .requirements ul { padding-left: 1.2rem; margin: 0.3rem 0; }
        .error { color: #dc3545; font-size: 0.9rem; margin-top: 0.5rem; text-align: center; }
    </style>
    ...
    <div class="container">
        <div class="auth-container">
            ...
            <div class="google-btn-container">
                <div id="g_id_onload"
                     data-client_id="1032401011225-pcjeocvpdigthv15u1qu1hmv8p61cuc0.apps.googleusercontent.com"
                     data-context="signin"
                     data-ux_mode="popup"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (urlParams.has('registered')) {
                showToast('Registration successful! Please check your email to verify your account.', 'info', 10000);
            }
