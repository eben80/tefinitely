...
async function startSession(level, language) {
    ...
    try {
        ...
        const res = await fetch('practise/celpip/section_a/api/start_session.php', {
            method: 'POST',
...
async function sendMessage() {
    ...
    try {
        const res = await fetch('practise/celpip/section_a/api/continue_session.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
...
async function showHints() {
    ...
    try {
        const res = await fetch('practise/celpip/section_a/api/get_hints.php');
        const data = await res.json();
