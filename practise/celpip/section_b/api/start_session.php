...
$scenario_instructions = "Create a CELPIP Section B style scenario. Subject: $chosen. Include clear instructions and ad content. Provide the friend's first line.";
$system_prompt = "You are a CELPIP examiner for Section B.
