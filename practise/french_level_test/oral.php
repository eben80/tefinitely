...
function showResults() {
    ...
    const descriptions = {
        'A1': 'Vous avez des bases très limitées en communication. Continuez à pratiquer les interactions simples.',
        'A2': 'Vous comprenez des situations de communication courantes et pouvez y répondre simplement.',
        'B1': 'Vous pouvez interagir avec une certaine assurance dans des situations familières ou en voyage.',
        'B2': 'Vous communiquez avec spontanéité et aisance dans une grande variété de situations.',
        'C1': 'Vous maîtrisez les subtilités de la langue et les différents registres de langue avec fluidité.',
        'C2': 'Votre aisance à l\'oral est comparable à celle d\'un locuteur natif, même dans des contextes complexes.'
    };
