...
<title>Privacy Policy - TEFinitely</title>
<meta name="description" content="Read the Privacy Policy for TEFinitely to understand how we collect, use, and protect your personal information.">
<link rel="canonical" href="https://tefinitely.com/privacy.php">
...
<div class="container">
    <div class="legal-content">
        ...
        <p>Your privacy is important to us. This Privacy Policy explains how TEFinitely ("we", "us", or "our") collects, uses, and protects your information when you use our website and services.</p>

        <h2>2. Information We Collect</h2>
        <ul>
            <li><strong>Personal Information:</strong> When you register, we collect your name and email address.</li>
            <li><strong>Usage Data:</strong> We collect information about how you use our site, including practice sessions and flashcard progress.</li>
            <li><strong>Technical Data:</strong> We collect IP addresses, browser types, and operating systems to ensure compatibility and security.</li>
        ...
        <p>We use industry-standard security measures to protect your data. Your password is encrypted. However, no method of transmission over the Internet is 100% secure.</p>

        <h2>5. Sharing Your Information</h2>
        <p>We do not sell your personal information. We may share data with third-party service providers (like PayPal for payments or OpenAI for AI features) as necessary to provide our service. These providers are bound by their own privacy policies.</p>

        <h2>6. Cookies and Tracking</h2>
        <p>You can control cookies through your browser settings. Note that disabling cookies may affect the functionality of the site.</p>

        <h2>7. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal information. You can manage most of your data through your profile page or contact us for assistance.</p>

        <h2>8. Changes to This Policy</h2>
        <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>

        <h2>9. Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:tefinitely@gmail.com">tefinitely@gmail.com</a>.</p>
    </div>
</div>
